/* 
   Illustrates the use of mcmc_continue_from_file() to continue a
   previous chain.

   Run the program "lines" first in order to generate the initial file
...
int main()
{
    ...
    /* load previous file */
    mcmc_continue_from_file(&config, "lines.h5");
